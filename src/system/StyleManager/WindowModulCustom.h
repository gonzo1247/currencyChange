...
static void ApplyCustomWindowStyle(HWND hwnd, COLORREF accentColor)
{
	...
	// Set Accent Color
	SetWindowTheme(hwnd, L" ", L" "); // This allows the title bar to use accent color
	INT elements[1] = { COLOR_WINDOW };
	SetSysColors(1, elements, &accentColor);
